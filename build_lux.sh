...
#!/bin/bash
KERNEL_DIR=/home/nickv/data/firekernel/kernel
...
export ARCH=arm
export SUBARCH=arm
export CROSS_COMPILE=/home/nickv/data/firekernel/prebuilts/arm-eabi-4.8/bin/arm-eabi-
export KBUILD_BUILD_USER="GtrCraft"
export KBUILD_BUILD_HOST="Horsebox"
...
replace $old $ver -- $KERNEL_DIR/arch/arm/configs/lux_defconfig
...
rm -f /home/nickv/data/firekernel/*.zip
cd flash_zip
zip -r ../arch/arm/boot/fire_kernel.zip ./
today=$(date +"-%d%m%Y")
mv /home/nickv/data/firekernel/kernel/arch/arm/boot/fire_kernel.zip /home/nickv/data/firekernel/FireKernel-$anv-$dev-v$ver$today.zip
}
